        ...
        <main className="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200 p-8">
          ...
          <table className="min-w-full bg-white rounded-lg overflow-hidden divide-y divide-gray-300 shadow-lg">
            <thead className="bg-green1 text-white">
              <tr>
                <th className="py-3 px-4 text-center text-xl font-bold uppercase w-24">usuario</th>
                <th className="py-3 px-4 text-center text-xl font-bold uppercase w-24">Nombre</th>
                <th className="py-3 px-4 text-center text-xl font-bold uppercase w-24">Teléfono</th>
                <th className="py-3 px-4 text-center text-xl font-bold uppercase w-24">País</th>
                <th className="py-3 px-4 text-center text-xl font-bold uppercase w-24">Administrador</th>
            ...
            <tbody>
              {usuarios.map((usuario) => (
                <tr key={usuario.usuario}>
                    ...
                    <td className="py-2 px-4 text-lg text-center">{usuario.usuario}</td>
                    <td className="py-2 px-4 text-lg text-center">{usuario.nombre}</td>
                    <td className="py-2 px-4 text-lg text-center">{usuario.telefono}</td>
                    <td className="py-2 px-4 text-lg text-center">{usuario.pais}</td>
                    <td className="py-2 px-4 text-lg text-center">{usuario.isAdmin.toString()}</td>
          ...
          >
            ...
            <NuevoUsuario closeModal={closeModal} actualizarUsuarios={actualizarUsuarios}/>
